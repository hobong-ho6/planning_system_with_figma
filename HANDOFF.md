...
| [clinic](handoff/projects/clinic.md) | `hogeun` | 위키 `4667512757` + 하위 LPC `4686692164`·일본어 검수 `4685320765` | 09-04 | 위키 **v123** · LPC v14 · 검수 v9 · 게이트 **17건 P0=0** · **Landpress 다국어 70/70** · **일본어 검수 1라운드 전건 반영**(XLT 11/11 · LP 9/9) · `da-ps` 비공개 |
