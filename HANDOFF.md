...
| [unifi-mini-v2](handoff/projects/unifi-mini-v2.md) | `hogeun` | 위키 `4704515582` + LPC `4727978725` + 일본어 검수 `4750149077` · **29화면** | 09-16 | 본문 **v214** · LPC **v55** — 일본어 검수 전건 반영(XLT 39키 · LPC 51건 beta·prod) · URL 복사 토스트 **DP 등록 완료** · `UF_my_jpyc_connected_badge` 키 분리 등록 · **신규 `UF_my_history_empty_desc` ⚠️ Unifi 업로드 1건 대기** · 17일 버전 QA 중(배포 09-18) · 🔴 클리닉 한정해제 8개 파라미터 미확보 |
