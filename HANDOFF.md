...
| [sk-gifticon-migration](handoff/projects/sk-gifticon-migration.md) | `hogeun` | 위키 `4770508162` — SK 기프티콘 서버 이관(10/13) 고지 | 09-23 | 위키 v11 · 영향 실측 확정(상품권 전 상품) · ko 초안 단계 · 🔴 상세 배너 LPC 컬렉션 부재 · 올리브영은 OA 보충으로 종결 |
