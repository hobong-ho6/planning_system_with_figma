...
| [unifi-mini-v2-oa](handoff/projects/unifi-mini-v2-oa.md) | `hogeun` | 위키 `4725932984` · 예약 OA **16화면**(클리닉 12·여행 4) | 09-15 | 위키 **v40** — **발송 시간 제한 정책 확정**(스케줄 22~8시 금지 · **확정 메시지 T0는 예외**) · beta 전건 등록 완료(Landpress 16 `ko_KR` + LIAM 16) · ⚠️ hero·버튼 URL 임시값 · `ko_KR`만 · prod는 T0 1건 `isActive` No |
