...
| [unifi-mini-v2](handoff/projects/unifi-mini-v2.md) | `hogeun` | 위키 `4704515582` · **24+화면** | 09-10 | 위키 **v96** — 결제·Voucher/Clinic Detail·JPYC 서브 신설 + XLT·GA 정의(UIT/LV 확정) · 다른 위키와 키 재사용 교차검증(22건 교체) · `LPC 관리 영역` 신설 · **GA Screen ID 9건 확정 대기** |
