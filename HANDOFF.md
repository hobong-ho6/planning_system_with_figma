...
| [sk-gifticon-migration](handoff/projects/sk-gifticon-migration.md) | `hogeun` | 위키 `4770508162` — SK 기프티콘 서버 이관(10/13) 고지 | 09-23 | 위키 v13 · ko 초안 단계 · 🔴 ②·③ 구현 구조 승인 대기(XLT 2키 + LPC `maintenance_notice`) · 올리브영은 OA 보충으로 종결 |
