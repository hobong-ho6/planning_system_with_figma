...
| [unifi-mini-v2](handoff/projects/unifi-mini-v2.md) | `hogeun` | 위키 `4704515582` + LPC `4727978725` + 일본어 검수 `4750149077` · **29화면** | 09-16 | 본문 **v206** · LPC **v55** — ✅ **XLT 업로드 대기 전건 해소**(2,578키 실측) · **17일 버전 QA 중**(배포 09-18) · 🔴 클리닉 한정해제 8개 파라미터 미확보 · 일본어 검수 의견 회수 대기 |
