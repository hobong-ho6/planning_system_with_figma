...
| [clinic](handoff/projects/clinic.md) | `hogeun` | 위키 `4667512757` + LPC 하위 `4686692164` · 10화면 86키 + Landpress 9필드 | 09-04 | 위키 **v114** · LPC **v11** · 게이트 16건 P0=0 · **XLT 86키 등재 확인**(v1.7.5 · 2,461키) · 🔴 **표기 통일분 7키 재업로드 + Landpress 5필드 반영 대기**(사용자) |
