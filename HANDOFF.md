...
| [unifi-mini-v2](handoff/projects/unifi-mini-v2.md) | `hogeun` | 위키 `4704515582` + LPC `4727978725` + 일본어 검수 `4750149077` · **29화면** | 09-16 | 본문 **v207** · LPC **v55** — Voucher Detail 3번 **URL 복사 토스트 추가**(키 재사용 · ⚠️ **Dapp Portal 업로드 1건 대기**) · **17일 버전 QA 중**(배포 09-18) · 🔴 클리닉 한정해제 8개 파라미터 미확보 |
