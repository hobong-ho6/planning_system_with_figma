...
| [unifi-mini-v2-oa](handoff/projects/unifi-mini-v2-oa.md) | `hogeun` | 위키 `4725932984` 예약 OA 16화면 + `4725963532` 100엔딜 OA 2종 | 09-15 | 예약 OA 발송 시간 제한 정책 확정 · **100엔딜 리텐션 OA 재정의**(100엔딜 **미구매/구매 사용자** · 타이틀·본문·버튼 3줄 구조 · 히어로 스왑 · 구매 전용 URL) — **Landpress 20건(4항목×5로케일) 확정문·공개** · ⚠️ **LIAM 4건 구 스냅샷**(사용자가 `LOAD MESSAGE`→`UPDATE` 예정) · ⚠️ JA만 `還元` 유지 |
