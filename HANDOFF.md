...
| [unifi-mini-v2-oa](handoff/projects/unifi-mini-v2-oa.md) | `hogeun` | 위키 `4725932984` 예약 OA 16화면 + `4725963532` 100엔딜 OA 2종 | 09-15 | 예약 OA: 발송 시간 제한 정책 확정(스케줄 22~8시 금지 · 확정 T0 예외) · **100엔딜 리텐션 OA 2종 신규**(beta **234**·**235** / prod **1971** · **LIAM 전건 미생성**) · ⚠️ 235 CTA URL 임시·로케일 미생성 · 234 en·th·zh 구 문구(`published:false`) |
