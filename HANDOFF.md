...
| [cashback-disclaimer](handoff/projects/cashback-disclaimer.md) | `hogeun` | 위키 `4770505327`(+자식 `4774237088`) 캐시백 캠페인 문구·자격 조항 | 09-21 | JPYC 어뷰징 대응 — LPC 570필드 점검 **자격·국가·어뷰징 조항 0건**. 확정 **A 신규 7 · B 수정 4(35셀) · C 삭제 7필드(70셀)** · 기준 **LINE 계정 리전(일본)** · **캠페인 한정**. ⛔ **반영 전건 미착수** · 🔴 **약관 개정 확인이 본체**(화면 고지만으론 회수 근거 없음·소급 불가) |
