...
| [unifi-mini-v2-oa](handoff/projects/unifi-mini-v2-oa.md) | `hogeun` | 위키 `4725932984` 예약 OA 16화면 + `4725963532` 100엔딜 OA 2종 | 09-15 | 예약 OA 발송 시간 제한 정책 확정 · **100엔딜 리텐션 OA 2종 beta/prod 전건 완료**(Landpress 234·235·1971·1976 × 5로케일 = **20건 신문구·공개** · LIAM 4건 `isActive` Yes) · ⚠️ 구매대상 CTA URL 공유(임시) · **미결 0** |
