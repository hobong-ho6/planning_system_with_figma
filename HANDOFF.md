...
| [unifi-mini-v2-oa](handoff/projects/unifi-mini-v2-oa.md) | `hogeun` | 위키 `4725932984` 예약 OA 16화면 + `4725963532` 100엔딜 OA 2종 | 09-15 | 예약 OA 발송 시간 제한 정책 확정 · **100엔딜 리텐션 OA 재정의 완료**(100엔딜 **미구매/구매 사용자** · 3줄 구조 · 히어로 스왑 · 구매 전용 URL) — **Landpress 20건 확정문·공개** · 구 첨부 정리 · 🔜 **LIAM 4건 `LOAD MESSAGE`→`UPDATE`는 사용자가 직접**(Title도 구 명칭) · ⚠️ JA만 `還元` 유지 |
