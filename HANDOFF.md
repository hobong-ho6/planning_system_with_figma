...
| [sk-gifticon-migration](handoff/projects/sk-gifticon-migration.md) | `hogeun` | 위키 `4770508162` — SK 기프티콘 서버 이관(10/13) 고지 | 09-23 | 위키 v16 · ko 초안 단계 · 🔴 `category_promotion_banner`에 `maintenance`+스위치 2개 필드 추가 대기(FE) · 올리브영은 OA 보충으로 종결 |
