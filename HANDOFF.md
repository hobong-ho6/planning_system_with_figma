...
| [unifi-mini-v2](handoff/projects/unifi-mini-v2.md) | `hogeun` | 위키 `4704515582` + LPC `4727978725` + **일본어 검수 `4750149077`** · **28화면** | 09-15 | 본문 **v203** · LPC **v55** · 검수 **v4** — 세션 #13: `바우처 상세 - 툴팁`·`결제페이지 - 바텀시트` 신설(신규 5키) · **리뷰 「더보기」 3개 이상 노출** 확정 · **Admin 관리 대상에 설정 위치·등록 ID 매핑**(v7) · 일본어 검수 **22건** 반영 · ⛔ 혜택 비율 **5%·10%·합산 15%** · ⛔ 헤더 타이틀은 카테고리 1·2에만 · ⛔ ja `バウチャー`/`今すぐ購入` Figma 유지 · 🔴 **미결**: 클리닉 한정해제 8개 파라미터 · XLT 엑셀 업로드 **5파일** |
| [unifi-mini-v2-oa](handoff/projects/unifi-mini-v2-oa.md) | `hogeun` | 위키 `4725932984` 예약 OA 16화면 + `4725963532` 100엔딜 OA 2종 | 09-15 | 예약 OA: 발송 시간 제한 정책 확정(스케줄 22~8시 금지 · 확정 T0 예외) · **100엔딜 리텐션 OA 2종 신규** — 미사용자: beta **234**·prod **1971** 각 5로케일 + **LIAM beta/prod 생성 완료** · 구매대상: beta **235**(ko_KR) **LIAM 미생성** · ⚠️ 235 CTA URL 임시·로케일 미생성 · 234 en·th·zh 구 문구(`published:false`) |
