...
| [unifi-mini-v2](handoff/projects/unifi-mini-v2.md) | `hogeun` | 위키 `4704515582` + 하위 **LPC `4727978725`** · **25화면** | 09-14 | 본문 **v186** · LPC **v50** — ⛔ **혜택 비율 확정: 할인 5% · 캐시백 10% · 합산 소구 15%** · **§9-7 연동 필드 규칙 신설**(6필드·80셀, 비율 변경 시 동반 갱신) · **`voucher_product`(UIT) 신설·등록**(`my_voucher_detail`만 · LV·UIT × beta·prod 4곳 동치) · ⛔ `k_pick_shopping_product`·리뷰 본문 **관리 대상 아님** · **CU 가이드 상품 개편**(Figma 정본 · 캡션 5 신규 · 브랜드 3종 공식표기 확인) · **FAQ 「한국인과 동일한 가격」 삭제** · XLT 7키 통일 엑셀 **업로드 대기** · ⛔ **미결 4건 해소**(`최근 본 상품` `UF_` 유지 · `최대혜택가` 3키 유지 · 판단 3건 승인 · `my_voucher_detail` **병존 유지 확정**) · 🔴 **한정해제 8개 파라미터** 미결 → 파일 참조 |
