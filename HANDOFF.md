...
| [unifi-mini-v2](handoff/projects/unifi-mini-v2.md) | `hogeun` | 위키 `4704515582` + LPC `4727978725` + Admin `4725950300` · **29화면** | 09-16 | 본문 **v220** · LPC **v55** · Admin **v11** — 일본어 검수 전건 반영(XLT 39키 · LPC 51건 beta·prod) · 키 분리·빈 상태 문구 **등록 완료** · **홈탭2 상담수→리뷰수**(`UNIFY-11350` · ⚠️ **DP 업로드 대기 1건**) · 바우처 상세 배지=Admin 관리 · 17일 버전 QA 중(배포 09-18) · 🔴 클리닉 한정해제 8개 파라미터 미확보 |
