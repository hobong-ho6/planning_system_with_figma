...
| [cashback-disclaimer](handoff/projects/cashback-disclaimer.md) | `hogeun` | 위키 `4770505327`(+`4774237088`) — 전 바우처 | 09-22 | Ⅰ **2건**(ko 확정·⛔리스크팀 검토 대기) / Ⅱ **4건**·Ⅲ **7필드** 5개 언어 확정·**게이트 P0 0**·반영 지시 대기. ⛔ **LPC·XLT 전건 미착수** · 🔴 **구매 수량 한도 부재**(재판매 차단의 실질 방어선) |
