...
| [cashback-disclaimer](handoff/projects/cashback-disclaimer.md) | `hogeun` | 위키 `4770505327`(+`4774237088`) — 전 바우처 | 09-23 | Ⅰ **리스크팀 검토 완료**(`LNS-1622` · 확정문 2건 ⛔수정금지 · **결제페이지 단독**) · 위키 **v20** — 확정문 프레임 `75911-4154` 반영 + **5개 언어 확정**(게이트 P0 0) → 남은 건 **XLT 업로드**(Ⅰ 2키 + Ⅱ 1키 · 사용자) · Ⅱ·Ⅲ LPC 반영 완료(남은 건 XLT 업로드 1키) · 🔴 구매 수량 한도 부재 |
