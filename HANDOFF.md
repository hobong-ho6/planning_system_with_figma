...
| [unifi-mini-v2-oa](handoff/projects/unifi-mini-v2-oa.md) | `hogeun` | 위키 `4725932984` 예약 OA 16화면 + `4725963532` 100엔딜 OA 2종 | 09-15 | 예약 OA 발송 시간 제한 정책 확정 · **100엔딜 리텐션 OA 2종 beta/prod 전건 등록 완료**(Landpress 234·235·1971·1976 각 5로케일 + LIAM 4건 `isActive` Yes) · ⚠️ **EN·TH·ZH-TW가 구 문구인 채 게시** → 교체 또는 게시 해제 필요 · ⚠️ 구매대상 CTA URL 공유(임시) |
