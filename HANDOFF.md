...
| [unifi-mini-v2](handoff/projects/unifi-mini-v2.md) | `hogeun` | 위키 `4704515582` + 하위 **LPC `4727978725`** · **25화면** | 09-14 | 본문 **v184** · LPC **v45** · 의료문구 **v7** — 클리닉 `clinic_menu` **ACTIVE 22곳 전원 등재·beta↔prod 동치** · My 바우처 상세 **신규 3키** · **API 스펙 갱신 반영**(여행 `use_state` 6곳 폐기 · GA `voucher_status` · **GuideKim↔B/E 기준 병기**) · ⛔ `k_pick_shopping_product` **관리 대상 아님** · 🔴 **한정해제 8개 파라미터** 미결 → 파일 참조 |
