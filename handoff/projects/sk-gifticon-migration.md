...
> 담당자: `hogeun` · 마지막 갱신: 2026-09-23 · 세션 #1(Claude 참여 기준) · 위키 **v9**
>
...
- [ ] ⚠️ **P1 — My 제외로 생긴 공백**: 점검 중 **My › 상품권 상세 진입 사용자에게 뜨는 안내가 없다**(5-1에 표기). 대체 안내가 필요한지 확인. 미참조가 된 첨부 `notice_area_my_main.png` 처리도 함께
...
- 번역 게이트 **미해당** — 신규 노출 문구 없음(내부 구현 메모·구조 변경만)
