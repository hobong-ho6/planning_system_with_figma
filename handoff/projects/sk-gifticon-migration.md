...
> 담당자: `hogeun` · 마지막 갱신: 2026-09-23 · 세션 #1(Claude 참여 기준) · 위키 **v10**
>
...
- 첨부 7건: `notice_area_category_voucher.png` · `notice_area_voucher_detail_top.png` · `notice_area_voucher_detail_cta.png` · `oa_sample_1_notice/2_holder/3_delay.png` · ⚠️ **`notice_area_my_main.png`은 My 제외로 본문 미참조 상태**(삭제 미실행)
...
- **역산 일정(5-7)** — D-17(9/26 법무·ko 확정) → D-11(10/2 번역·반영) → **D-7(10/6 고지 개시)** → D-4(10/9 OA-2) → D-1(10/12 리허설) → D-Day(10/13)
...
- [ ] **P2 — 미참조 첨부 `notice_area_my_main.png` 처리**: My 제외로 본문에서 빠졌다(삭제 미실행)
