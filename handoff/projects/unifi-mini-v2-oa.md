...
> 담당자: `hogeun` · 마지막 갱신: 2026-09-16 · 세션 #4 · 마지막 커밋 `e8c052f`
>
> 📌 **범위는 예약 OA 16화면뿐이다**(2026-09-16 경계 정리). 같은 `md/OA.md` 규칙을 쓰는 **100엔딜 리텐션 OA 2종**은 위키 `4725963532` 소관이라 **[`100yen-deal`](100yen-deal.md)로 이관**했다 — 그쪽을 보라.
...
- **범위 경계** — 이 프로젝트는 `4725932984` 한 페이지다. `4725963532`(100엔딜)의 OA 2종은 `100yen-deal`이 담당한다
