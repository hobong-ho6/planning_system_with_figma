...
- **등록** — beta Landpress **234**(5로케일) · **235**(ko_KR만, 나머지 404) / prod **1971**(미사용자만 · **5로케일**)
- **LIAM HUB Event Message**(사용자 생성) — 미사용자 리텐션 beta `N6aa933a4f3f3e36a2adf4b6d` · prod `N6aa9340377e3bf6ac76a6955`. **구매 대상 리텐션은 미생성**(CTA URL 미확정)
