...
> 담당자: hogeun · 마지막 갱신: 2026-09-04 · 세션 #4 · 마지막 커밋 `95e140e`
...
- 위키: `4667512757` 「클리닉 예약 동선 개선」 — **현재 v114** (부모 `3910828993`)
  - **하위 `4686692164` 「클리닉 LPC(Landpress) 관리 영역 정리」**(2026-09-03 신설 · **v11**) — LPC 영역 10곳의 컬렉션·필드·구조·**실등록 JSON** + 크롭 이미지 10장
...
- 결정: **`프리미엄 라식`·`프리미엄 리프트 패키지` = 공식 상품명** · **Figma 원본 수정 15건 무시**(목록화도 안 함)
