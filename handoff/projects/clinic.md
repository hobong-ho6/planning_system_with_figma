...
> 담당자: hogeun · 마지막 갱신: 2026-09-04 · 세션 #4 · 마지막 커밋 `89f9b81`
...
- 위키: `4667512757` 「클리닉 예약 동선 개선」 — **현재 v115** (부모 `3910828993`)
...
- [ ] 🔴 **P0 XLT 7키 재업로드(사용자)** — 업로드된 것이 **표기 통일 이전 값(첨부 v2)** 이라 **7키 10셀이 어긋난다**. `xlt_clinic_unify_fix_7keys_20260904.xlsx`(위키 첨부) 1건만 올리면 된다 — `_bridge_cat_vision`·`_bridge_title`·`_detail_review_source`·`_mini_bridge_review_more`·`_section_review`·`_section_review_note`(ko) + `_badge_certified_desc`(5개 언어)
